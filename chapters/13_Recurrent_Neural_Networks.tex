...
\Def[LSTMs]: Long Short Term Memory models maintain a separate cell state $C_t$ controlled by three gates.
...
\Def[GRU]: Gated Recurrent Unit models simplify LSTMs by merging Cell/Hidden states and Forget/Input gates.
