...
\begin{align*}
    \underset{r_1\times \cdots\times r_a\times s_1\times\cdots\times s_c}{\TT} = \\
    \underset{r_1\times \cdots\times r_a\times s_1\times\cdots\times s_b}{\TP} \times_{s_1,\ldots,s_b} \underset{s_1\times\cdots\times s_b\times t_1\times\cdots\times t_c}{\TQ}
\end{align*}
...
\begin{align*}
    T_{\underbrace{i_1,\ldots,i_a}_{\text{``i''}}, \underbrace{k_1,\ldots,k_c}_{\text{``k''}}} :=\\
    \sum_{\underbrace{j_1,\ldots,j_b}_{\text{``j''}}} P_{\underbrace{i_1,\ldots,i_a}_{\text{``i''}}, \underbrace{j_1,\ldots,j_b}_{\text{``j''}}} Q_{\underbrace{j_1,\ldots,j_b}_{\text{``j''}}, \underbrace{k_1,\ldots,k_c}_{\text{``k''}}}
\end{align*}
