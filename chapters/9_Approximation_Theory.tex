...
\Def[Uniform Approximation] This specific type of convergence guarantees that the maximum error across the \textit{entire} domain \(K\) is bounded by \(\epsilon\). It is stricter than pointwise approximation.
